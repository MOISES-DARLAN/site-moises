...
//     ]
async function acessToServer(){
    const url = "https://api-cursos-gratis.onrender.com/cursos";
    ...
    <div class="card h-100">
        ...
        <div class="card-body p-4">
            <div class="text-center">
                <!-- Product name-->
                <h5 class="fw-bolder">${data.titulo}</h5>
        ...
        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
            <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="${data.link}">Ver mais</a></div>
        </div>
    </div>
</div>`;
}
